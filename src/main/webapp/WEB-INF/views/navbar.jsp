    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="list.food">HOME</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="listNotice.food">공지사항</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="product.food">상품정보</a>
          </li>
          <c:if test="${ type eq 'customer'}">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="bestProduct.food">베스트 상품 정보</a>
          </li>
          </c:if>
           <c:if test="${ type eq 'manager'}">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="mbestProduct.food">베스트 상품 정보</a>
          </li>
          </c:if>
          <c:if test="${ type eq 'manager'}">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="myproduct.food">내 상품</a>
          </li>
          </c:if>
          <c:if test="${ type eq 'customer'}"> 
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="mymenu.food">내 식단</a>
          </li>
           </c:if>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="qna.food">QNA</a>
          </li >
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="obesity.food">심심풀이</a>
          </li >
