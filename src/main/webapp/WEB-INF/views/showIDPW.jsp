	...
	<div class="container">
		...
		<nav class="navbar navbar-default navbar-fixed-top navbar"
			...
			<div class="container">
				...
				<div
					...
					<a href="login.food"><button type="button"
		...
		<div class="div_box">
			...
			<c:if test="${empty member}">
				<h1>해당 이메일로 가입된 아이디가 존재하지 않습니다</h1>
			</c:if>
			<c:if test="${ not empty member}">
				<h1>ID: ${member.id}</h1>
				<h1>PW: ${member.pass }</h1>
			</c:if>

			<a href="login.food"><button type="submit">로그인 화면</button></a>
			<p class="mt-5 mb-3 text-muted">&copy; 민식</p>
